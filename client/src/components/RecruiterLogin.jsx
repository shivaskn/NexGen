  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
      <form onSubmit={onSubmitHandler} className="relative bg-white p-10 rounded-xl text-slate-500">
        ...
        <p className="text-sm mt-3">Welcome back! Please {state} in to continue</p>
        ...
        {
            state === 'Login' &&  <p className="text-sm text-blue-600 my-4 cursor-pointer hover:underline">
            Forgot password?
          </p>
        }
        ...
        <img onClick={e=>setShowRecruiterLogin(false)} src={assets.cross_icon} className="absolute top-4 right-4 cursor-pointer" />
      </form>
    </div>
  );
};
